...
const translations: Translations = {
  ...
  startPlating: { zh: '去摆盘', en: 'Plate it' },
  platingEditorHint: { zh: '拖动切片调整位置 · 选中后可旋转 / 缩放', en: 'Drag to move · select to rotate / scale' },
  rotateLabel: { zh: '旋转', en: 'Rotate' },
  scaleLabel: { zh: '缩放', en: 'Scale' },
  resetLabel: { zh: '重置', en: 'Reset' },
